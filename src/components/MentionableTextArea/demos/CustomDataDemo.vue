...
const customIssues: MentionItem[] = [
  { value: '#001', listValue: '#001 修復登入頁面問題' },
  { value: '#002', listValue: '#002 新增用戶管理功能' },
  { value: '#003', listValue: '#003 優化頁面載入速度' },
]

const customEmojis: MentionItem[] = [
  { value: '🎉', listValue: '🎉 慶祝' },
  { value: '✅', listValue: '✅ 完成' },
  { value: '🚀', listValue: '🚀 發布' },
  { value: '🐛', listValue: '🐛 錯誤' },
